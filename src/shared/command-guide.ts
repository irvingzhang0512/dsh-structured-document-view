...
export const VIEW_COMMAND_GUIDE: readonly ViewGuideEntry[] = [
  ...
  { id: 'filter-tasks', level: 'simple', phrase: '只看任务', description: '筛选出任务节点（项目文档）。', commands: [{ name: 'set_filter', filter: { role: 'task' } }] },
  { id: 'filter-risks', level: 'simple', phrase: '只看风险', description: '筛选出风险节点（项目文档）。', commands: [{ name: 'set_filter', filter: { role: 'risk' } }] },
  { id: 'filter-in-progress-tasks', level: 'simple', phrase: '只看进行中的任务', description: '按角色与状态 AND 组合筛选（项目文档）。', commands: [{ name: 'set_filter', filter: { role: 'task', properties: { status: '进行中' } } }] },
  { id: 'filter-in-progress-strategies', level: 'simple', phrase: '只看进行中的策略', description: '按角色与状态 AND 组合筛选（项目文档）。', commands: [{ name: 'set_filter', filter: { role: 'strategy', properties: { status: '进行中' } } }] },
  { id: 'clear-filter', level: 'simple', phrase: '清除筛选', description: '取消角色/属性筛选，显示全部节点。', commands: [{ name: 'set_filter', filter: null }] },
